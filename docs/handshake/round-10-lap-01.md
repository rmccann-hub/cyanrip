...
Regenerated, because §D's consequence moved the `Handshake:` line. **Generated by
the commit that adds this lap, committed at the next one** — stated in the split
form for the reason lap 11 §F gives.
