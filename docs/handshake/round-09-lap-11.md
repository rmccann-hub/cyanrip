...
**"Round 9 lap 11: the round closes"**. Named by subject rather than hash, since a
lap cannot carry the hash of a tree containing it.

The golden reference regenerates in the following commit, subject
**"Regenerate the golden reference at lap 11"** — the `Handshake:` line changes
with this file. Generated by this lap's commit, committed at that one.
