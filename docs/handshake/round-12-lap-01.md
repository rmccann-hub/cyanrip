...
Both golden files were generated by a clean build of **`4b3a018`** and committed
at `77881d3`. Both, not one: the sample was generated by the same build. Two
commits are named because they are always different and always must be — the fix
builds the binary, a later commit checks in the artifact, and a file cannot
