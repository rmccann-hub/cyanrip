...
**Round 27 is open**, so `tools/release-gate.py --release-gate` exits 1 and
names it. **Round 26 closed** at our lap 6. It reviewed `.15` on a drive, and it opened before the real test, on the
