...
lap 1 proposes `PROTOCOL.md` v6, `OWNERSHIP.md` v3 and `seam-rules.md` v6 there,
by sha256. They are removed when they land, and until then the files at their
real paths are the ones both projects hold.
