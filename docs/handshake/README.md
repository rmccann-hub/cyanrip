...
| 21 | **OPEN** — laps 1–3 all sent; §0.2 closed by their refusal; §0.1 **not met**: the 2026-09-17 rig session ran `fe4d2c4`, not the test pin, so 1 of its 3 items is established. Lap 4 is **theirs**; our draft of it was withdrawn unsent | *(pin `fe4d2c4` frozen; **test pin `3952c03`** carries two agreed log changes and is what the session should have run)* | `round-21-lap-03.md` |
