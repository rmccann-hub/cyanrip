...
| next | **the Full acceptance on Platterpus 0.6.59 with `.16` installed.** `v0.6.59` is `183073b`, where `PIN_UNDER_REVIEW` is `221a1df`, so its section A accepts `.16`. The bundle goes into both repositories, then our lap 3 reads it |
