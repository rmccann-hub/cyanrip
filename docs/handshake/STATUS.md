...
| next | **Platterpus 0.6.59**, which the operator has named for the test. It must carry `PIN_UNDER_REVIEW` `221a1df`: their 0.6.58 does not, and its section A refuses `.16`. Then our lap 1's release, their lap 2, and the real test |
