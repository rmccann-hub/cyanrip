...
===================================
**Leaves beta.** Published as `release-manifest.json` seq 16, channel `stable`,
authorised by handshake round 10. `0.9.4-rc1+platterpus.5` (`ddf7ac3`) is
retained as the previous stable so downgrade stays possible.

The golden reference shipped with this release was **generated by `bde52d2`, the
version bump, and committed at `6a65b03`**. Those are always two commits and
