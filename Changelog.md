...
**`cyanrip-diagnostics/5`**, because a rename is not additive: a consumer keyed
on the old name silently gets nothing, which is worse than an unknown key it can
ignore.
