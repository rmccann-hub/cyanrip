...
and the provider contract's source anchor is unmoved.
 ...
 - **Round 14 laps 7, 9, 11, 13 and 14**, and their inbound counterparts. Lap 13
   ...
   > **The golden reference and the provider contract are generated by
   > `12d77c1`** — the commit that reshapes the `Cache model:` fix — **and committed at the commit after it**, because a generated
