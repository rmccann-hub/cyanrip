...
**The reference pair is now generated by `623251c` and committed at the commit
carrying this entry** — round 22 lap 3 moved the compiled `Handshake:` line to
`round 22 lap 3 OPEN, verdict GO`, so both artifacts were regenerated. It was
previously **generated by `89a57d6` and committed at `ae29818`**, which is the
pair that carries the §0.3 log change itself.
