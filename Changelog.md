...
and the provider contract's source anchor is unmoved.
 ...
 - **Round 14 lap 18, and the golden reference regenerated behind it.** The
   reference and the interrupted sample were **generated by `9752cf5`** (the
   commit that adds the lap) **and committed at the commit after it**. Those are
