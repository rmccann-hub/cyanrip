Unreleased
==========
**Golden reference regenerated for round 19 lap 3: generated by `dda4318`,
committed at the commit after it.** Two commits, never one. Adding the lap moved
the compiled-in `Handshake:` line from *"round 19 lap 1 OPEN, verdict OPEN"* to
*"round 19 lap 3 OPEN, verdict GO"*; no log line was reworded.

**ROUND 19 IS `GO`/`GO` once the operator releases lap 3**, on the unchanged pin
`fe4d2c4`. A procedure round: no build reviewed, no hardware, no behavioural
change.
