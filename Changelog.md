...
==========
 - **The golden reference is regenerated, and it had gone stale in FORMAT
   while every test passed over it.** Generated by `23cd4fc`, committed at
   `3a7e867` — never the same commit, because a generated artifact cannot
   carry the hash of the build that produced it.
