...
and the provider contract's source anchor is unmoved.
 ...
 - **Round 14 laps 7, 9 and 11**, and their inbound counterparts. Lap 11
   withdraws lap 9's §B — a claim about our own binary drawn from an absence in
   ...
   > **The golden reference is generated by `b27f3b8`** — the commit that adds
   > lap 11 — **and committed at `516cb72`**, the commit after it, because a
   > generated artifact cannot carry the hash of the build that produced it.
   > Only the compiled-in handshake state moved: `round 14 lap 9` to
   > `round 14 lap 11`.
